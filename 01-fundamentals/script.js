...
// Challenge: get info about drivers lincense in human readable string
obj.hasDiversLicense = true;


//my asnwer

obj.hasDriversLicenseStr = function() {
    switch (this.hasDiversLicense) {
        case true:
...
console.log(`${obj.fullName()} is a ${obj.height}-tall teacher, and ${obj.hasDriversLicenseStr()}.`)

// answer:
console.log(`${obj.fullName()} is a ${obj.height}-tall teacher, and ${obj.hasDiversLicense ? "a" : "no"} driver's license.`)
